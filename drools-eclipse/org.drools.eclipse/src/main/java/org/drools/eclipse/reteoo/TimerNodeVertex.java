 ...
 */
public class TimerNodeVertex extends BaseVertex {
    
    private static final String NODE_NAME = "TimerNode";
    
    private final TimerNode node;
     ...
     */
    public TimerNodeVertex(final TimerNode node) {
        super();
        this.node = node;
    }
    ...
    public String getHtml() {
        return NODE_NAME+" : " + this.node.getId() + this.node.getTimer();
    }
