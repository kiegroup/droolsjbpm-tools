 ...
 */
public class TraitProxyObjectTypeNodeVertex extends BaseVertex {

    private static final String  NODE_NAME = "TraitProxyObjectTypeNode";

    private final TraitProxyObjectTypeNode node;
     ...
     */
    public TraitProxyObjectTypeNodeVertex(final TraitProxyObjectTypeNode node) {
        super();
        this.node = node;
    }
