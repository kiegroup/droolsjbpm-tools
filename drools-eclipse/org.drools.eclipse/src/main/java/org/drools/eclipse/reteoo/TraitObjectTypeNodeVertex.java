 ...
 */
public class TraitObjectTypeNodeVertex extends BaseVertex {

    private static final String  NODE_NAME = "TraitObjectTypeNode";

    private final TraitObjectTypeNode node;
     ...
     */
    public TraitObjectTypeNodeVertex(final TraitObjectTypeNode node) {
        super();
        this.node = node;
    }
