...
public class QueryElementNodeVertex extends BaseVertex {
     ...
     */
    public QueryElementNodeVertex(final QueryElementNode node) {
        super();
        this.node = node;
    }
    ...
    public String getHtml() {
        return NODE_NAME + " : " + this.node.getId() + " : " + this.node.getQueryElement() == null ? "" : this.node.getQueryElement().getQueryName();
    }
    ...
    public String getQueryName() {
        return node.getQueryElement() == null ? null : node.getQueryElement().getQueryName();
    }
