 ...
 */
public class AlphaTerminalNodeVertex extends BaseVertex {

    private static final String        NODE_NAME = "AlphaTerminalNode";

    private final AlphaTerminalNode node;
     ...
     */
    public AlphaTerminalNodeVertex( final AlphaTerminalNode node) {
        super();
        this.node = node;
    }
